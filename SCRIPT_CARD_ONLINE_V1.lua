...
local XP_ITEM = {
    PENDANT           = {1852141582, 1953395044, 0, 0, 0, 0},
    RING              = {1852404232, 103, 0, 0, 0, 0},
    PEARL_CHOKER      = {1634035730, 1701731442, 27587, 0, 0, 0},
    EARRINGS          = {1918981392, 1735289202, 115, 0, 0, 0},
    DIADEM            = {1634290700, 7169380, 13407, 0, 0, 0},
    FEATHER_EAR_RINGS = {1634037278, 1919244404, 1920098629, 1936150121, 0, 0},
}
